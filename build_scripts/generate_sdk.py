"""Generate the bundled Lyra SDK models from the application source tree."""
...
def generate_sdk_interface(source: str, dest: str) -> None:
    ...
    source_code = source_path.read_text(encoding="utf8")
    ...
    dest_path.write_text(new_source, encoding="utf8")
