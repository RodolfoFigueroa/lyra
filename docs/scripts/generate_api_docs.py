...
PAGE_SPECS = (
    ...
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.sdk.models.plugin_v3", "StringInputV3"),
            sym("lyra.sdk.models.plugin_v3", "NumberInputV3"),
            sym("lyra.sdk.models.plugin_v3", "IntegerInputV3"),
            sym("lyra.sdk.models.plugin_v3", "BooleanInputV3"),
            sym("lyra.sdk.models.plugin_v3", "EnumInputV3"),
            sym("lyra.sdk.models.plugin_v3", "JsonSchemaInputV3"),
            sym("lyra.sdk.models.plugin_v3", "PluginOwnedInputSpecV3"),
            sym("lyra.sdk.models.plugin_v3", "BatchInputV3"),
            sym("lyra.sdk.models.plugin_v3", "InputSpecV3"),
            sym("lyra.sdk.models.plugin_v3", "OutputColumnTypeV3"),
            sym("lyra.sdk.models.plugin_v3", "TableOutputColumnV3"),
            sym("lyra.sdk.models.plugin_v3", "BatchedTableOutputColumnV3"),
            sym("lyra.sdk.models.plugin_v3", "TableOutputV3"),
            sym("lyra.sdk.models.plugin_v3", "FileOutputV3"),
            sym("lyra.sdk.models.plugin_v3", "OutputSpecV3"),
            sym("lyra.sdk.models.plugin_v3", "MetricManifestV3"),
            sym("lyra.sdk.models.plugin_v3", "PluginManifestV3"),
            sym("lyra.sdk.models.plugin_v3", "CompiledMetricManifestV3"),
            sym("lyra.sdk.models.plugin_v3", "CompiledPluginManifestV3"),
            sym("lyra.sdk.models.plugin_v3", "compile_plugin_manifest"),
        ),
    ),
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.sdk.models.metric", "MetricInfoV3"),
        ),
    ),
    PageSpec(
