...
PAGE_SPECS = (
    ...
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.sdk.models.job", "JobResult"),
    ...
    PageSpec(
        ...
        order=4,
        intro="Plugin models validate v2 runner plugin manifests and metric entries.",
        symbols=(
            sym("lyra.sdk.models.plugin_v2", "PluginInfoV2"),
            sym("lyra.sdk.models.plugin_v2", "MetricExecutionV2"),
            sym("lyra.sdk.models.plugin_v2", "SpatialInputKind"),
            sym("lyra.sdk.models.plugin_v2", "MetricManifestV2"),
            sym("lyra.sdk.models.plugin_v2", "PluginManifestV2"),
        ),
    ),
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.sdk.models.metric", "MetricInfoV2"),
        ),
    ),
    PageSpec(
