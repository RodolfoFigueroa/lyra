...
PAGE_SPECS = (
    ...
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.sdk.models.job", "JobMessageLevel"),
            sym("lyra.sdk.models.job", "JobEnvelope"),
            sym("lyra.sdk.models.job", "JobProgress"),
            sym("lyra.sdk.models.job", "JobMessage"),
            ...
            sym("lyra.sdk.models.job", "parse_job_event"),
    ...
    PageSpec(
        ...
        symbols=(
            ...
            sym("lyra.api", "RunOptions"),
            sym("lyra.api", "LyraAPIError"),
            sym("lyra.api", "MetricRunError"),
