...
If you are building a plugin, start with [Plugin Quickstart](plugin-quickstart/), follow the [Plugin Author Checklist](plugin-author-checklist/), then read [Plugin Manifests](plugin-manifests/), [Spatial Plugin Inputs](spatial-plugin-inputs/), [Runner Plugins](runner-plugins/), and the [lyra-sdk](lyra-sdk/) and [lyra-utils](lyra-utils/) package references.
